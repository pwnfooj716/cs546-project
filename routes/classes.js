...
router.put("/:classID/:assignmentID/:studentID/grade", (req, res) => {
    ...
    db.getAssignmentsForCourse(user.courses[classID].courseId).then((assignments) => {
        ...
        db.updateAssignmentGrade(studentID, user.courses[classID].courseId, grade).catch((err) => {
            res.json({error: err});
        });
    });
});
...
router.put("/:classID/:assignmentID/:studentID/comment", (req, res) => {
    ...
    db.getAssignmentsForCourse(user.courses[classID].courseId).then((assignments) => {
        ...
        db.updateAssignmentGrade(studentID, user.courses[classID].courseId, undefined, comment).catch((err) => {
            res.json({error: err});
        });
    });
});
